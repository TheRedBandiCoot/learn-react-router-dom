...
createServer({
  ...
  routes() {
    ...
    this.get('/vans', (schema, request) => {
      ...
      //@ Error In Vans
      return new Response(400, {}, { message: 'Error fetching All Vans' });
    });

    this.get('/vans/:id', (schema, request) => {
      const id = request.params.id;
      return schema.vans.find(id);
      return new Response(400, {}, { message: 'Error fetching Van' });
    });

    this.get('/host/vans', (schema, request) => {
      // Hard-code the hostId for now
      return schema.vans.where({ hostId: '123' });
      return new Response(400, {}, { message: 'Error fetching Host ALL Vans' });
    });
    ...
    this.get('/host/vans/:id', (schema, request) => {
      ...
      return new Response(400, {}, { message: 'Error fetching Host Van' });
    });
